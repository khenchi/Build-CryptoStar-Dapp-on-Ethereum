...
it('can add the star name and star symbol properly', async() => {
    ...
    let starId = 6;
    let instance = await StarNotary.deployed();
    await instance.createStar('KhalilStar', starId, {from: accounts[0]});
    assert.equal('Stars', await instance.name.call());
    assert.equal('S', await instance.symbol.call());
